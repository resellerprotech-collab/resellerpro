    ...
    return (
        <div className="space-y-6">
            ...
            <Card className="border-red-500/20 bg-red-500/5 dark:bg-red-950/10">
                <CardHeader>
                    <CardTitle className="text-red-600 dark:text-red-400 flex items-center gap-2 text-base sm:text-lg font-bold">
                ...
                <CardContent className="flex flex-col sm:flex-row justify-between items-stretch sm:items-center gap-4">
                    ...
                    <Button
                        ...
                        className="w-full sm:w-auto justify-center gap-2 font-semibold rounded-xl bg-red-600 hover:bg-red-700 text-white shadow-md shadow-red-500/20 h-10 px-5 text-xs sm:text-sm shrink-0"
                    >
