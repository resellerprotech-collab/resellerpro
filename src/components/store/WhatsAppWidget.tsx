...
export function WhatsAppWidget({ profile, theme }: WhatsAppWidgetProps) {
  ...
  return (
    ...
    >
      <div className="bg-white px-4 py-2.5 rounded-2xl shadow-xl shadow-slate-900/10 border border-slate-100 opacity-0 group-hover:opacity-100 translate-x-2 group-hover:translate-x-0 transition-all duration-300 pointer-events-none whitespace-nowrap">
