...
export function StoreAboutSection({
  ...
  const defaultPara1 = `${storeName} was born out of a simple idea — to make every online shopping experience seamless, joyful, and trustworthy.`
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 lg:gap-12 items-center">
          ...
          <div className="lg:col-span-6 space-y-6 text-left pr-0 lg:pr-4">
            ...
            <div>
              ...
              {/* Main Headline */}
              <h2 className="text-2xl sm:text-4xl md:text-5xl font-medium text-[#1C1917] ">
                {storyTitle}
              </h2>
            </div>
