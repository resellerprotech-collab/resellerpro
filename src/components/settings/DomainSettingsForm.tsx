  ...
  return (
    <div className="space-y-6">
      ...
      <div className="bg-white dark:bg-slate-900 rounded-2xl px-1 py-3 sm:p-6 border-0 sm:border border-slate-200/80 dark:border-slate-800 shadow-none sm:shadow-sm relative overflow-hidden">
        ...
        <div className="mt-4 bg-slate-50 dark:bg-slate-950/60 rounded-xl p-3 border border-slate-200/60 dark:border-slate-800 flex flex-col sm:flex-row sm:items-center justify-between gap-2.5">
          ...
          <button
            ...
            className="flex items-center justify-center gap-1.5 px-3 py-1.5 rounded-lg bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 text-xs font-semibold text-slate-700 dark:text-slate-300 hover:bg-slate-100 dark:hover:bg-slate-800 transition-colors"
          >
      ...
      <div className="bg-white dark:bg-slate-900 rounded-2xl px-1 py-3 sm:p-6 border-0 sm:border border-slate-200/80 dark:border-slate-800 shadow-none sm:shadow-sm relative overflow-hidden">
          ...
          <div className="flex items-start sm:items-center gap-3">
            <div>
              ...
              <p className="text-xs text-slate-500 dark:text-slate-400 mt-0.5">
                Connect your own domain name (e.g. <span className="font-semibold text-slate-700 dark:text-slate-300">www.mybrandstore.com</span>) to build instant brand trust.
              </p>
            </div>
          </div>
        </div>
        ...
        {errorMsg && (
          <div className="mt-4 p-3.5 rounded-xl bg-rose-50 dark:bg-rose-950/40 border border-rose-200 dark:border-rose-800 text-rose-700 dark:text-rose-300 text-xs flex items-start gap-2.5">
        ...
        {successMsg && (
          <div className="mt-4 p-3.5 rounded-xl bg-emerald-50 dark:bg-emerald-950/40 border border-emerald-200 dark:border-emerald-800 text-emerald-800 dark:text-emerald-200 text-xs flex items-start gap-2.5">
        ...
        {loading ? (
          ...
          <div className="mt-6 space-y-5">
            ...
            {/* Status Header */}
            <div className="flex flex-col sm:flex-row sm:items-center justify-between p-4 rounded-xl bg-slate-50 dark:bg-slate-950 border border-slate-200 dark:border-slate-800 gap-3">
              <div className="flex items-center gap-3">
                <div className={`p-2 rounded-full ${domainInfo.status === 'active' ? 'bg-emerald-100 dark:bg-emerald-950 text-emerald-600 dark:text-emerald-400' : 'bg-amber-100 dark:bg-amber-950 text-amber-600 dark:text-amber-400'}`}>
                ...
                <div>
                  ...
                  <div className="text-xs text-slate-500 dark:text-slate-400">
                    Status:{' '}
                    <span className={`font-semibold ${domainInfo.status === 'active' ? 'text-emerald-600 dark:text-emerald-400' : 'text-amber-600 dark:text-amber-400'}`}>
            ...
            {/* DNS Setup Guide Box */}
            <div className="p-5 rounded-xl bg-slate-900 dark:bg-slate-950 text-white space-y-4 shadow-lg border border-slate-800">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-3 text-xs">
                ...
                {/* Record A */}
                <div className="bg-slate-800/80 dark:bg-slate-900 rounded-lg p-3 border border-slate-700/60 space-y-1.5">
              ...
              <div className="flex flex-col sm:flex-row sm:items-center gap-2.5 sm:gap-2">
                <div className="relative flex-1 w-full">
                  <input
                    ...
                    className="w-full pl-3.5 pr-4 py-2.5 rounded-xl border border-slate-200 dark:border-slate-800 bg-white dark:bg-slate-950 text-sm text-slate-900 dark:text-slate-100 placeholder:text-slate-400 focus:outline-none focus:ring-2 focus:ring-amber-500/20 focus:border-amber-500 transition-all"
                    required
                  />
                </div>
                <button
